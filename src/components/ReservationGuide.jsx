        ...
        <section className="how-it-works">
          <div className="container">
            <div className="text-xs-center">
              ...
              <div className="row how-it-works-solution">
                <div className="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                  <div className="how-it-works-wrap">
                    <div className="step step-1">
                      ...
                      <p>
                        Choose your favourite Restauarnt and go ahead
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                  <div className="step step-2">
                    ...
                    <p>
                      Select your meal from available Foods and live your happy life
                    </p>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                  <div className="step step-3">
                    ...
                    <h3>Go & Enjoy</h3>
                    <p>
                      Get your food served! And enjoy your meal!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-sm-12 text-center">
                <p className="pay-info">Pay by Card or Cash on Spot</p>
              </div>
            </div>
          </div>
        </section>
